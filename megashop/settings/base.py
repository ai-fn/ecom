...
PRODUCT_IMAGE_WIDTH = os.getenv("PRODUCT_IMAGE_WIDTH", 1280)
PRODUCT_IMAGE_HEIGHT = os.getenv("PRODUCT_IMAGE_HEIGHT", 920)
PRODUCT_IAMGE_FORMAT=os.getenv("PRODUCT_IAMGE_FORMAT", "webp")

PRODUCT_CATALOG_IMAGE_WIDTH = os.getenv("PRODUCT_CATALOG_IMAGE_WIDTH", 500)
PRODUCT_CATALOG_IMAGE_HEIGHT = os.getenv("PRODUCT_CATALOG_IMAGE_HEIGHT", 500)
PRODUCT_CATALOG_IAMGE_FORMAT=os.getenv("PRODUCT_CATALOG_IAMGE_FORMAT", "webp")

PRODUCT_SEARCH_IMAGE_WIDTH = os.getenv("PRODUCT_SEARCH_IMAGE_WIDTH", 42)
PRODUCT_SEARCH_IMAGE_HEIGHT = os.getenv("PRODUCT_SEARCH_IMAGE_HEIGHT", 50)
PRODUCT_SEARCH_IAMGE_FORMAT=os.getenv("PRODUCT_SEARCH_IAMGE_FORMAT", "webp")
